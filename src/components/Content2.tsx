    ...
    <section className="w-full mobile:h-[940px]  pc:h-[866px] pc:px-[6.5%] pc:py-[6.5%] overflow-hidden bg-gradient-to-b from-primary via-primary/95 to-[#212121">
      ...
      <div className="relative z-10 flex h-full items-start justify-center mobile:px-10 mobile:pt-[30px]">
        <div className="flex w-full mobile:max-w-[313px] pc:max-w-[1200px] flex-col items-center mobile:gap-4 pc:gap-[52px]">
          ...
          {/* Title */}
          <div className="text-center pc:pb-0">
          ...
          <div className="mobile:block pc:hidden w-full max-w-[243px] relative">
            <div className="relative rounded-[4.93px] overflow-hidden">
              <Image
                src="/img/home/mobile-content2-inner.webp"
          ...
          {/* Features Section */}
          <div className="mobile:block pc:hidden w-full absolute bottom-0">
            <div className="mobile:px-6 mobile:py-6 pc:px-0 pc:py-0 border-t-[1px] border-[#262626]  bg-gradient-to-b from-primary to-[#212121]">
              <div className="flex flex-col mobile:gap-6 pc:gap-8  ">
                {features.map((feature, index) => (
                  <div key={index}>
                    <FeatureCard feature={feature} />
                    {index < features.length - 1 && (
                      <div className="h-[1px] bg-[#262626] mobile:mt-[4px] pc:mt-8"></div>
                    )}
                  </div>
                ))}
              </div>
